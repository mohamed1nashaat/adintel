...
import type { Objective } from '@/stores/dashboard'
...
const selectedObjective = computed({
  ...
  set: (value: Objective) => dashboardStore.setObjective(value)
})

const handleObjectiveChange = (objective: Objective) => {
  dashboardStore.setObjective(objective)
  // Refresh data with new objective
